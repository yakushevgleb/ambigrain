...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 512.5, 991.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 497.5, 976.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 482.5, 961.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 467.5, 946.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 452.5, 931.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.5, 916.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 422.5, 901.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.5, 886.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 815.5, 20.0, 15.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "trouble.button",
							"parameter_mmax" : 1,
							"parameter_shortname" : "trouble.button",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 865.5, 411.0, 69.0, 22.0 ],
					"text" : "target 0, $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 791.5, 411.0, 69.0, 22.0 ],
					"text" : "target 0, $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1131.0, 23.5, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 684.25, 140.5, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "grain.gap",
							"parameter_mmax" : 2000.0,
							"parameter_shortname" : "grain.gap",
							"parameter_type" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1049.25, 70.5, 63.5, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 673.0, 89.0, 63.5, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_longname" : "min.grain.size",
							"parameter_initial_enable" : 1,
							"parameter_mmax" : 100.0,
							"parameter_initial" : [ 10.0 ],
							"parameter_shortname" : "min.grain.size",
							"parameter_type" : 0,
							"parameter_unitstyle" : 0
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 717.5, 411.0, 69.0, 22.0 ],
					"text" : "target 0, $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 1060.5, 23.5, 41.0, 48.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 630.0, 89.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 467.25, 476.0, 69.0, 22.0 ],
					"text" : "target 0, $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 389.0, 476.0, 69.0, 22.0 ],
					"text" : "target 0, $1"
				}
...
, 			{
				"box" : 				{
					"activebgcolor" : [ 0.349019607843137, 0.866666666666667, 0.576470588235294, 1.0 ],
					"activebgoncolor" : [ 0.388235294117647, 0.662745098039216, 0.717647058823529, 1.0 ],
					"automation" : "left",
					"automationon" : "right",
					"id" : "obj-78",
					"maxclass" : "live.text",
					...
					"presentation" : 1,
					"presentation_rect" : [ 345.0, 111.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 102.0, 20.0, 26.0, 161.5 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 140.5, 113.0, 41.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 478.0, 89.0, 98.0, 95.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 578.0, 89.0, 50.0, 93.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 430.0, 89.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 345.0, 89.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 266.5, 89.0, 44.0, 15.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 410.5, 133.5, 83.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 325.5, 133.5, 83.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 247.0, 133.5, 83.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 113.0, 362.0, 365.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 1,
						"defer" : 0,
						"node_bin_path" : "",
						"npm_bin_path" : "",
						"options" : [ "--v8-pool-size=4" ],
						"watch" : 0
					}
,
					"text" : "node.script engine_core.js @autostart 1 @options --v8-pool-size=4"
				}
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.56078431372549, 0.67843137254902, 0.772549019607843, 1.0 ],
					"border_color" : [ 0.501960784313725, 0.501960784313725, 0.501960784313725, 1.0 ],
					"constrain" : 2,
					"coord_color" : [ 0.807843137254902, 0.898039215686275, 0.909803921568627, 1.0 ],
					...
					"presentation" : 1,
					"presentation_rect" : [ 132.0, 20.0, 113.0, 113.0 ],
					"prototypename" : "small_light_grey",
					"save_points" : 1,
					"saved_points" : [ "1", 1, -0.622110271704725, -0.701012938072208, 0.0, -138.412714889166637, 0.0, 0.937251476128555, 0, 0.0, 0.0, 0.0, 0, 0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 684.25, 20.0, 177.0, 169.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 369.25, 574.0, 265.0, 22.0 ],
					"text" : "poly~ metrograin~ 50 @parallel 1 args sample-1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 196.5, -1.0, 256.0, 64.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 399.0, 20.0, 337.5, 64.0 ],
					"setmode" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 257.0, 20.0, 140.0, 64.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"grad1" : [ 0.623529411764706, 0.662745098039216, 0.305882352941176, 1.0 ],
					"grad2" : [ 0.607843137254902, 0.47843137254902, 0.47843137254902, 1.0 ],
					"id" : "obj-36",
					"maxclass" : "panel",
					"mode" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 785.600006000000121, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 84.0, 12.5, 755.0, 194.0 ],
					"proportion" : 0.5
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-45" : [ "min.grain.size", "min.grain.size", 0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "metrograin~.maxpat",
				"bootpath" : "~/Documents/Max 8/Projects/Pigeons",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
