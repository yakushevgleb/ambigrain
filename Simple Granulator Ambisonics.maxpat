...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 573.0, 311.0, 51.0, 22.0 ],
					"text" : "puls 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 547.0, 241.0, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 241.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 199.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 745.0, 532.0, 45.0, 22.0 ],
					"text" : "open 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 657.0, 658.0, 157.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 975.0, 611.0, 57.0, 22.0 ],
					"text" : "pack s 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1002.0, 568.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 914.0, 658.0, 206.0, 22.0 ],
					"text" : "/coord_x3 -0.002929"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 881.0, 597.0, 57.0, 22.0 ],
					"text" : "pack s 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 892.0, 532.0, 84.0, 22.0 ],
					"text" : "unpack 0 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 881.0, 568.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 892.0, 497.0, 57.0, 22.0 ],
					"text" : "route xyz"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 873.0, 710.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 341.0, 240.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 800.5, 605.0, 52.0, 22.0 ],
					"text" : "open 49"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.0, 312.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 39.0, 138.0, 53.0, 49.0 ],
					"text" : "xyz 51 0.1 -0.6 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 40.0, 53.0, 49.0 ],
					"text" : "\"xyz 51 0.1 -0.6 0\""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 69.0, 100.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.0, 283.0, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 430.842857142857156, 508.0, 49.0, 22.0 ],
					"text" : "target 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 811.0, 538.0, 45.0, 22.0 ],
					"text" : "open 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 745.0, 494.0, 45.0, 22.0 ],
					"text" : "open 1"
				}
...
, 			{
				"box" : 				{
					...
					"prototypename" : "small_light_grey",
					"save_points" : 1,
					"saved_points" : [ "1", 1, 0.000720060780756, -0.00015339033376, 0.0, 102.02563015116317, 0.0, 0.000736217442386, 0, 0.0, 0.0, 0.0, 0, 0, "2", 2, 0.012877262702685, -0.009078226656191, 0.0, 125.183112751205428, 0.0, 0.01575557342451, 0, 0.0, 0.0, 0.0, 0, 0, "3", 3, -0.002929349562556, 0.000172252753751, 0.0, -86.634746393189786, 0.0, 0.002934409629009, 0, 0.0, 0.0, 0.0, 0, 0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 442.75, 55.0, 256.0, 64.0 ],
					"setmode" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 244.0, 55.0, 140.0, 60.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
